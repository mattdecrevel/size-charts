...
<script src="${getBaseUrl()}/embed/size-charts.js" data-api="${getBaseUrl()}"></script>`;
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Live Builder</h1>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {/* Configuration Panel */}
        <div>
          <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-4">Configuration</h2>
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300">Embed Code</h3>
              <button

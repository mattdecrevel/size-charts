...
import { TableProperties, Settings, Code2, FileText, History } from "lucide-react";

const navLinks = [
  { name: "Demo", href: "/size-guide/demo", icon: Code2 },
  { name: "API", href: "/size-guide/api", icon: FileText },
